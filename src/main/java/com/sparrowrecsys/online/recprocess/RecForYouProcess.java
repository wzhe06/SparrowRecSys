...
import com.sparrowrecsys.online.util.HttpClient;
...
public class RecForYouProcess {
    ...
    public static void callNeuralCFTFServing(User user, List<Movie> candidates, HashMap<Movie, Double> candidateScoreMap){
        ...
        String predictionScores = HttpClient.asyncSinglePostRequest("http://localhost:8501/v1/models/recmodel:predict", instancesRoot.toString());
