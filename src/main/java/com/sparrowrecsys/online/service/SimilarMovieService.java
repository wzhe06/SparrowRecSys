...
import com.sparrowrecsys.online.recprocess.MySimilarMovieProcess;
...
public class SimilarMovieService extends HttpServlet {
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            List<Movie> movies = MySimilarMovieProcess.getRecList(Integer.parseInt(movieId), Integer.parseInt(size), model);
